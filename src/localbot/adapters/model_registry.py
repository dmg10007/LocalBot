...
class ModelRegistry:
    ...
    def __init__(self) -> None:
        ...
        # Build slot configs from environment.
        # Per-slot overrides (SLOT_GENERAL_N_GPU_LAYERS etc.) take priority;
        # unset values fall back to the legacy llama_server_* globals so that
        # single-model setups continue to work without any .env changes.
        self._slots: dict[SlotName, _SlotConfig] = {
            "general": _SlotConfig(
                name="general",
                model_path=cfg.slot_general_model,
                port=cfg.slot_general_port,
                n_gpu_layers=cfg.slot_general_n_gpu_layers,
                ctx_size=cfg.slot_general_ctx_size,
                threads=cfg.slot_general_threads,
                extra_args=cfg.slot_general_extra_args,
            ),
            "coding": _SlotConfig(
                name="coding",
                model_path=cfg.slot_coding_model,
                port=cfg.slot_coding_port,
                n_gpu_layers=cfg.slot_coding_n_gpu_layers,
                ctx_size=cfg.slot_coding_ctx_size,
                threads=cfg.slot_coding_threads,
                extra_args=cfg.slot_coding_extra_args,
            ),
            "reasoning": _SlotConfig(
                name="reasoning",
                model_path=cfg.slot_reasoning_model,
                port=cfg.slot_reasoning_port,
                n_gpu_layers=cfg.slot_reasoning_n_gpu_layers,
                ctx_size=cfg.slot_reasoning_ctx_size,
                threads=cfg.slot_reasoning_threads,
                extra_args=cfg.slot_reasoning_extra_args,
            ),
        }
